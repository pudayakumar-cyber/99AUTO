...
Route::group(['middleware' => ['adminlocalize', 'demo']], function () {
    Route::prefix('admin')->group(function () { 
        ...
        Route::group(['middleware' => 'permissions:Feeds'], function () {
            //------------ TRANSACTION ----------------//
            Route::get('/feeds', 'Back\ProductFeedController@index')->name('back.feeds.index');
...
Route::group(['middleware' => 'maintainance'], function () {
    Route::group(['middleware' => 'localize'], function () {
        ...
        //------------ VEHICLE API ------------
        Route::get('years', 'VehicleController@years')->name('vehicle.years');
        Route::get('makes/{year}', 'VehicleController@makes')->name('vehicle.makes');
        Route::get('models/{make}', 'VehicleController@models')->name('vehicle.models');
        ...
        //------------ PAGE ------------
        // Route::get('/page/{slug}', 'Front\FrontendController@page')->name('front.page');
        Route::get('/page/{slug}', 'Front\FrontendController@page')
...
Route::post('/admin/import-items', function (\Illuminate\Http\Request $request) {
    $path = $request->file('csv')->store('import');
    Artisan::call('import:items', [
        'csv_path' => storage_path('app/' . $path),
    ]);
