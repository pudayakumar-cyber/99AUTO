        ...
        $payload = [
            'data' => [[
                ...
                'user_data' => array_filter([
                    'em' => $this->hashEmail($email ?: ($billingInfo['bill_email'] ?? $shippingInfo['ship_email'] ?? optional($user)->email ?? null)),
                    'ph' => $this->hashPhone($phone ?: ($billingInfo['bill_phone'] ?? $shippingInfo['ship_phone'] ?? optional($user)->phone ?? null)),
                    'fn' => $this->hashText($billingInfo['bill_first_name'] ?? $shippingInfo['ship_first_name'] ?? optional($user)->first_name ?? null),
                    'ln' => $this->hashText($billingInfo['bill_last_name'] ?? $shippingInfo['ship_last_name'] ?? optional($user)->last_name ?? null),
                    'ct' => $this->hashText($billingInfo['bill_city'] ?? $shippingInfo['ship_city'] ?? optional($user)->bill_city ?? optional($user)->ship_city ?? null),
                    'st' => $this->hashText($billingInfo['bill_province'] ?? $shippingInfo['ship_province'] ?? optional($user)->bill_province ?? optional($user)->ship_province ?? null),
                    'zp' => $this->hashText($billingInfo['bill_zip'] ?? $shippingInfo['ship_zip'] ?? optional($user)->bill_zip ?? optional($user)->ship_zip ?? null),
                    'country' => $this->hashCountry($billingInfo['bill_country'] ?? $shippingInfo['ship_country'] ?? optional($user)->bill_country ?? optional($user)->ship_country ?? null),
