            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" min="0" id="package_length" name="package_length" class="form-control" value="{{ old('package_length') }}">
                    </div>
                    <div class="form-group">
                        <label for="package_width">{{ __('Package Width (in)') }}</label>
                        <input type="number" step="0.01" min="0" id="package_width" name="package_width" class="form-control" value="{{ old('package_width') }}">
                    </div>
                    <div class="form-group">
                        <label for="package_height">{{ __('Package Height (in)') }}</label>
                        <input type="number" step="0.01" min="0" id="package_height" name="package_height" class="form-control" value="{{ old('package_height') }}">
                    </div>
                    <div class="form-group">
                        <label for="package_weight">{{ __('Package Weight (lb)') }}</label>
                        <input type="number" step="0.01" min="0" id="package_weight" name="package_weight" class="form-control" value="{{ old('package_weight') }}">
                    </div>
                    <div class="form-group">
