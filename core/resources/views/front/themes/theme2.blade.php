                                            ...
                                            <div class="from-bottom">
                                                @if ($slider->logo)
                                                    <img class="d-inline-block brand-logo"
                                                        src="{{ asset('storage/images/' . $slider->logo) }}" alt="logo">
                                                @endif
            ...
            <div class="row gx-3">
                <div class="col-md-4">
                    <a href="{{ $banner_secend['url1'] }}" class="genius-banner">
                        <img class="lazy" data-src="{{ asset('storage/images/' . $banner_secend['img1']) }}"
                            alt="">
                        <div class="inner-content">
                ...
                <div class="col-md-4">
                    <a href="{{ $banner_secend['url2'] }}" class="genius-banner">
                        <img class="lazy" data-src="{{ asset('storage/images/' . $banner_secend['img2']) }}"
                            alt="">
                        <div class="inner-content">
                ...
                <div class="col-md-4">
                    <a href="{{ $banner_secend['url3'] }}" class="genius-banner">
                        <img class="lazy" data-src="{{ asset('storage/images/' . $banner_secend['img3']) }}"
                            alt="">
                        <div class="inner-content">
            ...
            <div class="row gx-3">
                <div class="col-md-6">
                    <a href="{{ $banner_third['url1'] }}" class="genius-banner">
                        <img class="lazy" data-src="{{ asset('storage/images/' . $banner_third['img1']) }}"
                            alt="">
                        <div class="inner-content">
                ...
                <div class="col-md-6">
                    <a href="{{ $banner_third['url2'] }}" class="genius-banner">
                        <img class="lazy" data-src="{{ asset('storage/images/' . $banner_third['img2']) }}"
                            alt="">
                        <div class="inner-content">
                                        ...
                                        @foreach ($two_column_category_itemt as $two_column_category_item)
                                            <div class="product-card p-col">
                                                ...
                                                ">
                                                    ...
                                                    <img class="lazy"
                                                        data-src="{{ asset('storage/images/' . $two_column_category_item->thumbnail) }}"
