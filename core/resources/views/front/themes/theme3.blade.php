            ...
            <div class="heroarea-slider owl-carousel">
                ...
                <div class="item" style="background: url('{{ asset('storage/images/' . $slider->photo) }}')">
                    ...
                    <div class="row">
                        ...
                        <div class="layer-4">
                            <div class="right-img">
                            <img class="img-fluid full-img" src="{{ asset('storage/images/' . $slider->logo) }}" alt="">
                            </div>
                        </div>
                        </div>
                    </div>
                    ...
                    @foreach ($services as $service)
                        <div class="col-lg-3 col-sm-6 text-center mb-30">
                            <div class="single-service single-service2">
                                <img src="{{ asset('storage/images/'.$service->photo) }}" alt="Shipping">
                                <div class="content">
                            ...
                            <div class="slider-item">
                                <div class="product-card">
                                    <div class="product-thumb">
                                        ...
                                        @endif
                                            <img class="lazy" data-src="{{asset('storage/images/'.$popular_category_item->thumbnail)}}" alt="{{ $popular_category_item->name }}">
