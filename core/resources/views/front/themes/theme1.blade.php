                                    ...
                                    <div class="product-card">
                                        ...
                                        <div class="product-card-body">
                                            ...
                                            <div class="rating-stars">
                                                {!! Helper::renderStarRating($compaign_item->item->reviews_avg_rating) !!}
                                            </div>
                                ...
                                <div class="slider-item">
                                    <div class="product-card">
                                        ...
                                        <div class="product-card-body">
                                            ...
                                            <div class="rating-stars">
                                                {!! Helper::renderStarRating($popular_category_item->reviews_avg_rating) !!}
                                            </div>
                                            <h4 class="product-price">
                        ...
                        <div class="col-gd">
                            <div class="product-card">
                                ...
                                <div class="product-card-body">
                                    ...
                                    <div class="rating-stars">
                                        {!! Helper::renderStarRating($feature_category_item->reviews_avg_rating) !!}
                                    </div>
                                    <h4 class="product-price">
...
<div class="section-title brand-section-header">
                            <h2 class="h3 mb-0">{{ __('Popular Brands') }}</h2>
                            <button class="brand-toggle-btn" type="button"
                                data-show-text="{{ __('Show All Brands') }}"
                                data-hide-text="{{ __('Hide All Brands') }}">
                                {{ __('Show All Brands') }}
                            </button>
                        </div>
                    </div>
...
<!--        <section class="popular-brands-section">
            <div class="container">
                ...
                <div class="popular-brands-center">
                    <a href="{{ route('front.catalog') }}?brand=bremsen" class="brand-box">
                        <img src="{{ url('/core/public/storage/images/OM_1767066202pjMxFiBd.png') }}" alt="Bremsen">
                    </a>

                    <a href="{{ route('front.catalog') }}?brand=99AutoParts" class="brand-box">
                        <img src="{{ url('/core/public/storage/images/yb6bnewChatGPT Image Dec 27, 2025, 01_55_15 AM.png') }}" alt="99AutoParts">
                    </a>
                </div>
            </div>
        </section> -->
