    ...
    @if ($extra_settings->is_t4_slider == 1)
        <div  class="hero-area3 hero-area4" >
            ...
            <div class="heroarea-slider owl-carousel">
                ...
                <a href="{{$slider->link}}">
                    <div  class="item" style="background: url('{{ asset('storage/images/' . $slider->photo) }}')">
                    </div>
                </a>
                @endforeach
            </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12">
                        <a href="{{isset($home_page4_banner['url1']) ? $home_page4_banner['url1'] : ''}}" class="h3-category">
                            <img class="lazy" data-src="{{asset('storage/images/'.$home_page4_banner['img1'])}}" alt="">
                        ...
                        <a href="{{isset($home_page4_banner['url2']) ? $home_page4_banner['url2'] : ''}}" class="h3-category">
                            <img class="lazy" data-src="{{asset('storage/images/'.$home_page4_banner['img2'])}}" alt="">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 middleImage">
                        <a href="{{isset($home_page4_banner['url3']) ? $home_page4_banner['url3'] : ''}}" class="h3-category">
                            <img class="lazy" data-src="{{asset('storage/images/'.$home_page4_banner['img3'])}}" alt="">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12">
                        <a href="{{isset($home_page4_banner['url4']) ? $home_page4_banner['url4'] : ''}}" class="h3-category">
                            <img src="{{asset('storage/images/'.$home_page4_banner['img4'])}}" alt="">
                        ...
                        <a href="{{isset($home_page4_banner['url5']) ? $home_page4_banner['url5'] : ''}}" class="h3-category">
                            <img src="{{asset('storage/images/'.$home_page4_banner['img5'])}}" alt="">
            ...
            <div class="row gx-3">
                <div class="col-md-4">
                    <a href="{{$banner_first['firsturl1']}}" class="genius-banner">
                        <img src="{{ asset('storage/images/'.$banner_first['img1']) }}" alt="">
                ...
                <div class="col-md-4">
                    <a href="{{$banner_first['firsturl2']}}" class="genius-banner">
                        <img src="{{ asset('storage/images/'.$banner_first['img2']) }}" alt="">
                        <div class="inner-content">
                ...
                <div class="col-md-4">
                    <a href="{{$banner_first['firsturl3']}}" class="genius-banner">
                        <img src="{{ asset('storage/images/'.$banner_first['img3']) }}" alt="">
                        <div class="inner-content">
            ...
            <div class="row gx-3">
                <div class="col-md-4">
                    <a href="{{$banner_secend['url1']}}" class="genius-banner">
                        <img class="lazy" data-src="{{ asset('storage/images/'.$banner_secend['img1']) }}" alt="">
                        <div class="inner-content">
                ...
                <div class="col-md-4">
                    <a href="{{$banner_secend['url2']}}" class="genius-banner">
                        <img class="lazy" data-src="{{ asset('storage/images/'.$banner_secend['img2']) }}" alt="">
                        <div class="inner-content">
                ...
                <div class="col-md-4">
                    <a href="{{$banner_secend['url3']}}" class="genius-banner">
                        <img class="lazy" data-src="{{ asset('storage/images/'.$banner_secend['img3']) }}" alt="">
                        <div class="inner-content">
            ...
            <div class="row gx-3">
                <div class="col-md-6">
                    <a href="{{$banner_third['url1']}}" class="genius-banner">
                        <img class="lazy" data-src="{{ asset('storage/images/'.$banner_third['img1']) }}" alt="">
                        <div class="inner-content">
                ...
                <div class="col-md-6">
                    <a href="{{$banner_third['url2']}}" class="genius-banner">
                        <img class="lazy" data-src="{{ asset('storage/images/'.$banner_third['img2']) }}" alt="">
                        <div class="inner-content">
                        ...
                        <div class="brand-slider owl-carousel">
                            ...
                            <div class="slider-item">
                                <a class="text-center" href="{{ route('front.catalog') . '?brand=' . $brand->slug }}">
                                    ...
                                    data-src="{{ asset('storage/images/' . $brand->photo) }}"
                    ...
                    @foreach ($services as $service)
                        <div class="col-lg-3 col-sm-6 text-center mb-30">
                            <div class="single-service single-service2">
                                <img class="lazy" data-src="{{ asset('storage/images/'.$service->photo) }}" alt="Shipping">
                                <div class="content">
